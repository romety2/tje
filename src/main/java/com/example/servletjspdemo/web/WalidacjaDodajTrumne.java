...
@WebServlet(urlPatterns = "/walidacjaDodajTrumne")
public class WalidacjaDodajTrumne extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            request.setAttribute("trumna", trumna);
            request.getRequestDispatcher("komunikatDodanoTrumne.jsp").forward(request, response);
        }
        catch(Exception e)
        {
