...
@WebServlet(urlPatterns = "/walidacjaDodajPogrzeb")
public class WalidacjaDodajPogrzeb extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            request.getRequestDispatcher("komunikatDodanoPogrzeb.jsp").forward(request, response);
        }
        catch(Exception e)
        {
